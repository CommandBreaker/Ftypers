...
def examgui(number):
    ...
    def donecheck():
        ...
        length = end - start
        similarity = int(fuzz.ratio(rawtext, selectedtext))
        nethiz = int(length) / int(len(rawtext.split()))
        nethiz2 = 60 // nethiz
        nethiz3 = int(nethiz2)
        toplam = int(similarity) + int(nethiz2)
        messagebox.showinfo("Sonuç", "Benzerlik Oranı = " + str(similarity) + "\nNet Hız (Dk/Kelime) = " + str(nethiz3) + "\nToplam = " + str(toplam))
        ...
        try:
            with open(filee2,"w", encoding="utf-8") as file:
                ...
                file.write("Ftypers |" + today + "| BK\n" + "----------------------------------------\n" + "Adı Soyadı : " + str(isim) + "\nTest Adı : " + str(number) + " Nolu Metin\n" + "Tarih : " + today + "\n----------------------------------------\n" + "TEST SONUÇLARI\n\n" + "Benzerlik Orani = " + str(similarity) + "\nNet Hız (Dk/Kelime) = " + str(nethiz3) + "\n\nToplam = " + str(toplam) + "\n----------------------------------------\n" + "Orjinal Metin\n\n" + selectedtext + "\n----------------------------------------\n" + "Öğrencinin Yazdığı Metin\n\n" + rawtext + "\n----------------------------------------\n" + str(isim) + "\n\n\n\n\n==========\nİmza")
        except Exception as e:
            None
        exam.destroy()
